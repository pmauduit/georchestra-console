...
public class AdvancedDelegationDaoIT extends ConsoleIntegrationTest {
    ...
    // TODO previously based on the com.mchange.c3p0 connection pooler
    // switching to hikari as it is already available in the classpath.
    // But does it change the meaning of the test ?
    private @Autowired HikariDataSource dataSource;
